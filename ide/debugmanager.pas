...
begin
  ...
  begin
    ...
    AW := GetActiveWindow;
    IDEWindowCreators.ShowForm(CurDialog,
      BringToFront or (DebuggerOptions.AlwaysBringDbgDialogsToFront and Application.Active),
      vmOnlyMoveOffScreenToVisible);
    if (AW <> 0) and (not BringToFront) and DebuggerOptions.AlwaysBringDbgDialogsToFront
    then
      SetActiveWindow(AW);
    CurDialog.EndUpdate;
  end;
