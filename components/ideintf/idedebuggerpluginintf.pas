...
uses
  Classes, SysUtils, fgl, Laz2_XMLCfg;
  ...
  *)
  ...
  ILazDbgIdePlugInConfiguration = interface ['{48487C9E-C904-4E0E-AB27-1B21E3BB015C}']
    (* GetSettingsFrameClass
       A TFrame class. This will be instantiated by the IDE to show and edit config.
       This frame provides a ILazDbgIdePlugInSettingsFrameIntf interface, and
       must be able to sync with the config interface
    *)
    function GetSettingsFrameClass: TClass; virtual; // class(TFrame, ILazDbgIdePlugInSettingsFrameIntf)
    (* GetConfigObject
       for TXmlConfig.ReadObject/WriteObject / must have all config in published fields
