...
const
  ...
  GroupDebugger     = 400;
    ...
    DbgOptionsExcludedRoutines   = 500;
  ...
  GroupProject      = 100100;
    ...
    ProjectOptionsDbgExcludedRoutines   = 1000;
    ProjectOptionsDbgDisplayFormat      = 1100;
    ProjectOptionsDbgValueFormatter     = 1200;
    ProjectOptionsDbgValueConvert       = 1300;
