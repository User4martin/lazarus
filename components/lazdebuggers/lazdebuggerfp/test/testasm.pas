...
begin
  ...
  TestDis('aesdeclast xmm2,XMMWORD PTR [rdi+rax*1]',   #$66#$0f#$38#$df#$14#$07,                 'aesdeclast xmm2,XMMWORD PTR [rdi+rax*1]');
  TestDis('aesdeclast xmm2,XMMWORD PTR [rsi+rax*1]',   #$66#$0f#$38#$df#$14#$06,                 'aesdeclast xmm2,XMMWORD PTR [rsi+rax*1]');
  ...
  TestDis('pinsrd xmm4,DWORD PTR [rsi+$f],$3a',        #$66#$0f#$3a#$22,                         'pinsrd xmm4,DWORD PTR [rsi+$f],$3a');
  ...
  TestDis('pinsrw mm1,WORD PTR [rdi],$c4',             #$0f#$c4,                                 'pinsrw mm1,WORD PTR [rdi],$c4');
  TestDis('pinsrw mm2,WORD PTR [rdi],$2',              #$0f#$c4#$17#$02,                         'pinsrw mm2,WORD PTR [rdi],$2');
  TestDis('pinsrw xmm4,WORD PTR [rsi+$f],$c4',         #$66#$0f#$c4,                             'pinsrw xmm4,WORD PTR [rsi+$f],$c4');
  ...
  TestDis('pinsrw xmm0,ebp,$b1',                       #$66#$0f#$c4,                             'pinsrw xmm0,ebp,$b1');
  ...
  TestDis('insertps xmm0,xmm4,$e3',                    #$66#$0f#$3a#$21,                         'insertps xmm0,xmm4,$e3');
  ...
  TestDis('pclmulqdq xmm0,xmm4,$e3',                   #$66#$0f#$3a#$44,                         'pclmulqdq xmm0,xmm4,$e3');
  TestDis('vpclmulhqlqdq xmm1,xmm2,XMMWORD PTR [rdi]', #$c4#$e3#$69#$44#$0f#$01,                 'vpclmulhqlqdq xmm1,xmm2,XMMWORD PTR [rdi]');
  TestDis('vpclmulhqlqdq xmm7,xmm2,XMMWORD PTR [rsi]', #$c4#$e3#$69#$44#$3e#$01,                 'vpclmulhqlqdq xmm7,xmm2,XMMWORD PTR [rsi]');
  TestDis('vpclmullqhqdq xmm7,xmm2,XMMWORD PTR [rsi]', #$c4#$e3#$69#$44#$3e#$02,                 'vpclmullqhqdq xmm7,xmm2,XMMWORD PTR [rsi]');
  ...
  TestDis('aesdeclast xmm2,XMMWORD PTR [edi+eax*1]',   #$67#$66#$0f#$38#$df#$14#$07,             'aesdeclast xmm2,XMMWORD PTR [edi+eax*1]');
  TestDis('aesdeclast xmm2,XMMWORD PTR [esi+eax*1]',   #$67#$66#$0f#$38#$df#$14#$06,             'aesdeclast xmm2,XMMWORD PTR [esi+eax*1]');
  ...
  TestDis('insertps xmm2,DWORD PTR [esi],$4',          #$67,                                     'insertps xmm2,DWORD PTR [esi],$4');
  ...
  TestDis('pinsrw mm4,WORD PTR [rdi+$f],$c4',          #$0f#$c4,                                 'pinsrw mm4,WORD PTR [rdi+$f],$c4');
  TestDis('pinsrw mm2,WORD PTR [edi],$2',              #$67#$0f#$c4#$17#$02,                     'pinsrw mm2,WORD PTR [edi],$2');
  TestDis('pinsrw mm4,WORD PTR [rdi+$66],$f',          #$0f#$c4,                                 'pinsrw mm4,WORD PTR [rdi+$66],$f');
  ...
  TestDis('pinsrw mm4,WORD PTR [rdi-$3b],$b1',         #$0f#$c4,                                 'pinsrw mm4,WORD PTR [rdi-$3b],$b1');
  ...
  TestDis('vpclmulhqlqdq xmm1,xmm2,XMMWORD PTR [edi]', #$67#$c4#$e3#$69#$44#$0f#$01,             'vpclmulhqlqdq xmm1,xmm2,XMMWORD PTR [edi]');
  TestDis('vpclmulhqlqdq xmm7,xmm2,XMMWORD PTR [esi]', #$67#$c4#$e3#$69#$44#$3e#$01,             'vpclmulhqlqdq xmm7,xmm2,XMMWORD PTR [esi]');
  TestDis('vpclmullqhqdq xmm7,xmm2,XMMWORD PTR [esi]', #$67#$c4#$e3#$69#$44#$3e#$02,             'vpclmullqhqdq xmm7,xmm2,XMMWORD PTR [esi]');
  ...
  TestDis('aesdeclast xmm2,XMMWORD PTR [edi+eax*1]',   #$66#$0f#$38#$df#$14#$07,               'aesdeclast xmm2,XMMWORD PTR [edi+eax*1]');
  TestDis('aesdeclast xmm2,XMMWORD PTR [esi+eax*1]',   #$66#$0f#$38#$df#$14#$06,               'aesdeclast xmm2,XMMWORD PTR [esi+eax*1]');
  TestDis('aesdeclast xmm2,xmm3',                      #$66#$0f#$38#$df#$d3,                   'aesdeclast xmm2,xmm3');
  ...
  TestDis('pinsrw mm1,WORD PTR [edi],$c4',             #$0f#$c4,                               'pinsrw mm1,WORD PTR [edi],$c4');
  TestDis('pinsrw mm2,WORD PTR [edi],$2',              #$0f#$c4#$17#$02,                       'pinsrw mm2,WORD PTR [edi],$2');
  TestDis('pinsrw xmm4,WORD PTR [esi+$f],$c4',         #$66#$0f#$c4,                           'pinsrw xmm4,WORD PTR [esi+$f],$c4');
  ...
  TestDis('vpinsrd xmm6,xmm2,DWORD PTR [edi],$1',      #$c4#$e3#$e9#$22#$37#$01,               'vpinsrd xmm6,xmm2,DWORD PTR [edi],$1');
  TestDis('vpinsrd xmm3,xmm7,DWORD PTR [esi],$2',      #$c4#$e3#$c1#$22#$1e#$02,               'vpinsrd xmm3,xmm7,DWORD PTR [esi],$2');
  ...
  TestDis('pinsrw xmm0,ebp,$c1',                       #$66#$0f#$c4,                           'pinsrw xmm0,ebp,$c1');
  ...
  TestDis('vinsertps xmm1,xmm2,xmm3,$1',               #$c4#$e3#$69#$21#$cb#$01,               'vinsertps xmm1,xmm2,xmm3,$1');
  TestDis('pclmulqdq xmm0,xmm4,$e3',                   #$66#$0f#$3a#$44,                       'pclmulqdq xmm0,xmm4,$e3');
  TestDis('vpclmulhqlqdq xmm1,xmm2,XMMWORD PTR [edi]', #$c4#$e3#$69#$44#$0f#$01,               'vpclmulhqlqdq xmm1,xmm2,XMMWORD PTR [edi]');
  TestDis('vpclmulhqlqdq xmm7,xmm2,XMMWORD PTR [esi]', #$c4#$e3#$69#$44#$3e#$01,               'vpclmulhqlqdq xmm7,xmm2,XMMWORD PTR [esi]');
  TestDis('vpclmullqhqdq xmm7,xmm2,XMMWORD PTR [esi]', #$c4#$e3#$69#$44#$3e#$02,               'vpclmullqhqdq xmm7,xmm2,XMMWORD PTR [esi]');
