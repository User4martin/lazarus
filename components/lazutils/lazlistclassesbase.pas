...
type
  ...
  TLazListAspectCapacityFixed = object
  public
    class procedure Init(); inline; static;
  ...
  private type
    ...
    TCapacityT      = TLazListAspectCapacityFixed;
...
class procedure TLazListAspectCapacityFixed.Init();
begin
  // nothing
end;
...
begin
  assert(False, 'TLazListAspectCapacityFixed.GrowCapacity: False');
  Result := ARequired;
end;
...
begin
  assert(False, 'TLazListAspectCapacityFixed.ShrinkCapacity: False');
  Result := ARequired;
end;
