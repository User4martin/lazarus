...
{$unDEFINE UnicodeRE} // Use WideChar for characters and UnicodeString/WideString for strings
...
type
  ...
  private
    ...
    function ExecPrim(AOffset: integer; ATryOnce, ASlowChecks, ABackward: boolean; AMatchMustStartBefore: Integer = 0): boolean;
  ...
  public
    ...
    function Exec(AOffset, AMatchMustStartBefore: integer): boolean; overload;
    {$ENDIF}
...
function TRegExpr.Exec(AOffset, AMatchMustStartBefore: integer): boolean;
begin
  Result := ExecPrim(AOffset, False, False, False, AMatchMustStartBefore);
end;
...
function TRegExpr.ExecPrim(AOffset: integer; ATryOnce, ASlowChecks,
  ABackward: boolean; AMatchMustStartBefore: Integer): boolean;
var
  Ptr: PRegExprChar;
begin
  Result := False;
  ...
  if (AMatchMustStartBefore > 0) and (AOffset >= AMatchMustStartBefore) then
    Exit;
  ...
  repeat
    ...
    begin
      ...
      if Ptr > fInputEnd then
        Exit;
      if (AMatchMustStartBefore > 0) and (Ptr - fInputStart >= AMatchMustStartBefore - 1) then
        Exit;
    end;
