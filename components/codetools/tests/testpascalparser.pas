...
procedure CheckNodeTree(Tool: TCodeTool; Test: TTestCase; UnfinishedSource: boolean = False);

implementation

procedure CheckNodeTree(Tool: TCodeTool; Test: TTestCase; UnfinishedSource: boolean);
