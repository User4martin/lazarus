...
type
  ...
  TSynHashEntry = class(TSynHashEntryBase)
  private
    function GetNext: TSynHashEntry; inline;
  protected
  ...
  public
    ...
    property Next: TSynHashEntry read GetNext;
  end;
...
function TSynHashEntry.GetNext: TSynHashEntry;
begin
  Result := TSynHashEntry(fNext);
end;
